...
urlpatterns = [
    ...
    path('staff', views.homepg, name="staff"),
    path('customer_join', views.customer_join, name="customer_join"),
    path('additional_info/<str:pk>/', views.additional_info, name="additional_info"),
    
    
    path('clockin/<str:pk>/', views.clockin, name="clockin"),
    path('clockout/<str:pk>/', views.clockout, name="clockout"),
